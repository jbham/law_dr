...
#####AWS COGNITO #####
AWS_USER_POOL_ID = os.getenv("AWS_USER_POOL_ID")    # "us-west-2_pi0xD1Bvz"
AWS_USER_POOL_CLIENT_ID = os.getenv("AWS_USER_POOL_CLIENT_ID")

###### AWS LAMBDAS #####
AWS_FULL_DOC_SPLITTER_LAMBDA = os.getenv("AWS_FULL_DOC_SPLITTER_LAMBDA")
AWS_IP = os.getenv("AWS_IP")

# ----------AWS SQS-----------
AWS_SQS_Q_NAME = os.getenv("AWS_SQS_Q_NAME")
# print("test from config")
